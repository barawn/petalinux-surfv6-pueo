...
set psu_mio_init_data {
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00B02004
    ...
    mask_write 0XFF180144 0x03FFFFFF 0x03EFFFFF
    ...
    mask_write 0XFF180160 0x03F7FFFF 0x03F7FFFF
    ...
    mask_write 0XFF180164 0x03FFFFFF 0x03FFFF7F
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF0A0208 0x03FFFFFF 0x00020000
    ...
    mask_write 0XFF0A0248 0x00000000 0x00000000
    ...
    mask_write 0XFF0A0004 0x03FF03FF 0x00000000
    ...
    mask_write 0XFF0A0008 0x00000000 0x00000000
    ...
    mask_write 0XFF0A0008 0x0000FFFF 0x00000000
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5 MS DELAY
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00002400
		# Register : OEN_1 @ 0XFF0A0248</p>
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00002400
		# Register : MASK_DATA_0_MSW @ 0XFF0A0004</p>
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0x00000000
}
