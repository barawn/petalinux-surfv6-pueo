...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00B02004U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFFFFFU, 0x00B02004U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Each bit applies to a single IO. Bit 0 for MIO[0].
    *  PSU_IOU_SLCR_BANK0_CTRL4_PULL_HIGH_LOW_N_BIT_20             0
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180144, 0x03FFFFFFU ,0x03EFFFFFU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL4_OFFSET,
		0x03FFFFFFU, 0x03EFFFFFU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180160, 0x03F7FFFFU ,0x03F7FFFFU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL4_OFFSET,
		0x03F7FFFFU, 0x03F7FFFFU);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180164, 0x03FFFFFFU ,0x03FFFF7FU)
    */
...
/*##################################################################### */
    ...
    *  PSU_GPIO_DIRM_0_DIRECTION_0                                 0x20000

    * Direction mode (GPIO Bank0, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0204, 0x03FFFFFFU ,0x00020000U)
    */
	PSU_Mask_Write(GPIO_DIRM_0_OFFSET, 0x03FFFFFFU, 0x00020000U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF0A0244, 0x00000000U ,0x00000000U)
    */
	PSU_Mask_Write(GPIO_DIRM_1_OFFSET, 0x00000000U, 0x00000000U);
/*##################################################################### */
    ...
    *  PSU_GPIO_OEN_0_OP_ENABLE_0                                  0x20000

    * Output enable (GPIO Bank0, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0208, 0x03FFFFFFU ,0x00020000U)
    */
	PSU_Mask_Write(GPIO_OEN_0_OFFSET, 0x03FFFFFFU, 0x00020000U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF0A0248, 0x00000000U ,0x00000000U)
    */
	PSU_Mask_Write(GPIO_OEN_1_OFFSET, 0x00000000U, 0x00000000U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF0A0004, 0x03FF03FFU ,0x00000000U)
    */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF0A0008, 0x00000000U ,0x00000000U)
    */
...
/*##################################################################### */
    ...
    * Maskable Output Data (GPIO Bank1, MIO, Lower 16bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0008, 0x0000FFFFU ,0x00000000U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_1_LSW_OFFSET,
...
/*##################################################################### */
    ...
    *  PSU_GPIO_DIRM_1_DIRECTION_1                                 0x2400

    * Direction mode (GPIO Bank1, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0244, 0x03FFFFFFU ,0x00002400U)
    */
	PSU_Mask_Write(GPIO_DIRM_1_OFFSET, 0x03FFFFFFU, 0x00002400U);
/*##################################################################### */
    ...
    *  PSU_GPIO_OEN_1_OP_ENABLE_1                                  0x2400

    * Output enable (GPIO Bank1, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0248, 0x03FFFFFFU ,0x00002400U)
    */
	PSU_Mask_Write(GPIO_OEN_1_OFFSET, 0x03FFFFFFU, 0x00002400U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Operation is the same as MASK_DATA_0_LSW[MASK_0_LSW]
    *  PSU_GPIO_MASK_DATA_1_LSW_MASK_1_LSW                         0x0

    * Operation is the same as MASK_DATA_0_LSW[DATA_0_LSW]
    *  PSU_GPIO_MASK_DATA_1_LSW_DATA_1_LSW                         0x0

    * Maskable Output Data (GPIO Bank1, MIO, Lower 16bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0008, 0xFFFFFFFFU ,0x00000000U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_1_LSW_OFFSET,
